        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SSSEmployerNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhilHealthEmployerNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PagIbigEmployerNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsNationwide = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NightDifferentialMinutes = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VacationLeaveBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SickLeaveBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    VacationLeaveUsed = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NightDifferentialPay = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    UndertimeDeduction = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    ProcessedById = table.Column<int>(type: "int", nullable: true),
                    ProcessedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DaysWorked = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    UndertimeHours = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
